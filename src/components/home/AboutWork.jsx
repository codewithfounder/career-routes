                ...
                <div class="col-lg-3 col-md-6 col-sm-6 m-b20 icon-wrapper">
                  <div class="icon-bx-wraper style-1">
                    <div class="icon-content">
                      <a class="icon-box text-white m-b20" href="javascript:void(0);">
                        <svg fill="none" height="32" viewbox="0 0 31 32" width="31" xmlns="http://www.w3.org/2000/svg">
                          <path d="M30.2807 28.9357L22.7865 21.1419C24.7134 18.8515 25.7691 15.9697 25.7691 12.9695C25.7691 5.96007 20.0659 0.257202 13.056 0.257202C6.04609 0.257202 0.342865 5.96007 0.342865 12.9695C0.342865 19.979 6.04609 25.6819 13.056 25.6819C15.6876 25.6819 18.1954 24.8882 20.3395 23.3815L27.8906 31.2344C28.2062 31.5622 28.6307 31.7429 29.0856 31.7429C29.5162 31.7429 29.9247 31.5788 30.2348 31.2803C30.8937 30.6463 30.9147 29.5951 30.2807 28.9357ZM13.056 3.57347C18.2374 3.57347 22.4527 7.78844 22.4527 12.9695C22.4527 18.1507 18.2374 22.3656 13.056 22.3656C7.87457 22.3656 3.65934 18.1507 3.65934 12.9695C3.65934 7.78844 7.87457 3.57347 13.056 3.57347Z" fill="white">
                          </path>
                        </svg>
                      </a>
                      <a class="dez-tilte" href="company-manage-job.html">
                        Search Jobs
                      </a>
                      <p class="dz-text">
